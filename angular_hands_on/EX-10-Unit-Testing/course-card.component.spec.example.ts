// Example: Unit test specification for CourseCardComponent
...
describe('CourseCardComponent', () => {
  ...
  // Mock course object fixture for test suite
  ...
  // Configure testing environment before each test spec
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CourseCardComponent] // Standalone component import
    }).compileComponents();
